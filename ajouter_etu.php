...
<html lang="en">
  <head>
    <title>Espace Admin | Etudiants</title>
    <meta charset="utf-8">
...
.button:hover span:after {
  ...
  <body>
     <form   action="ajouter_e.php" method="POST">
...
<div class="wrapper">
  <div class="contact-form">
    <div class="input-fields">
      <input type="text"  class="input" name="nome" placeholder="Nom d'étudiant "  pattern="[A-Z ]*"  >
      <input type="text"  class="input" name="prenome" placeholder="Prenom d'étudiant" pattern="[A-Z ]*"   >
      <input type="text"  class="input" name="lieu" placeholder="Lieu de naissance" pattern="[A-Z ]*" >
      <input type="date"  class="input" name="date" placeholder="Date de naissance" ></div>
   <div class="input-fields">  
      <input type="text"  class="input" name="adr" placeholder="Adresse" pattern="[A-Z ]*" >
      <input type="tel"  class="input" name="tele" placeholder="téléphone" pattern="[0-9]{10}">
      <input type="text"  class="input"  class="input" name="Cni" placeholder="Cni" pattern="[A-Z]{2}[0-9]{5,6}">
      <input type="text"  class="input" name="Cne" placeholder="Cne" pattern="[A-Z]{1}[0-9]{9}">  </br>
   </div>
      <div class="msg">
    <form action="">  </br><font color="white" >Département  </br>
